    ...
    <html lang="en">
      <body className={classNames(inter.className, 'bg-white')}>
        ...
        <header className={styles.backgroundHeader}   >
          ...
          <span className='text-lg md:text-2xl lg:text-3xl pr-2 xl:text-5xl xl:leading-relaxed xl:pr-2 '>🪅</span>
          <div>
            <h1 className='text-lg md:text-2xl lg:text-3xl lg:leading-relaxed xl:text-5xl xl:leading-relaxed '> Festividades de Nicaragua</h1>
            <p className='text-sm md:text-base lg:text-lg font-medium xl:text-2xl xl:space-y-10 xl:pl-4 xl:leading-relaxed xl:tracking-wide'>Bienvenido a nuestro sitio dedicado a las <br /> celebraciones festivas de Nicaragua.</p>
          </div>
          {/* Menú de Navegación */}
        ...
        <footer className={styles.backgroundFooter}>
          ...
          <span className='text-sm lg:text-lg self-center lg:self-end lg:absolute lg:bottom-10'>
            Diseñado por: <a href='https://luichix.github.io/portafolio' target="_blank" className='font-bold'>Luichix</a>
          </span>
        </footer>
      </body>
    </html>
