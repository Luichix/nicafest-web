    ...
    <html lang="en">
      <body className={classNames(inter.className, 'bg-white')}>
        ...
        <header className={styles.backgroundHeader}   >
          ...
          <span className='text-5xl leading-relaxed pr-2'>🪅</span>
          <div>
            <h1 className='text-5xl leading-relaxed '> Festividades de Nicaragua</h1>
            <p className='text-2xl space-y-10 pl-4  font-medium leading-relaxed tracking-wide'>Bienvenido a nuestro sitio dedicado a las <br /> celebraciones festivas de Nicaragua.</p>
          </div>
          {/* Menú de Navegación */}
          <nav className='flex-grow pt-8 text-lg'>
